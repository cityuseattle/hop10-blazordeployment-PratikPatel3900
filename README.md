...
- ```mkdir CS504```(to create a directory for this course)<br/>
- ```cd CS504```(to change directory to CS504 you just created) </br>
...
KimNguyen/Desktop/CS504/HOP01-KimNguyenMai/Module 1 <br/>
